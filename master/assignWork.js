...
async function bucketConcatenate() {
    ...
    sortedBuckets.forEach(element => {
        try {
            writeFileSync(`master/autogeneratedFiles/csvFiles/sorted${fileName}.csv`, element, { encoding: 'utf8', flag: 'a+' });
            writeFileSync(`master/autogeneratedFiles/csvFiles/sorted${fileName}.csv`, ',', { encoding: 'utf8', flag: 'a+' });
        } catch (err) {
            console.error(err);
        }
